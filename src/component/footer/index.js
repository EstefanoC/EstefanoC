...
const Footer = () => {
    ...
    return (
        <footer className='footer'>
            ...
            <small className='text-center d-block w-100 pb-2'>Derechos reservados Copyright <CopyrightIcon style={{ color: '#6c757dad', fontSize: '1rem'}}/> 2021 Estefano Chacón</small>
        </footer>
    )
}
